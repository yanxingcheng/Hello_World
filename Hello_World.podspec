#
#  Be sure to run `pod spec lint Hello_World.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Hello_World"
  s.version      = "0.0.1"
  s.summary      = "A short description of Hello_World."
  ...
  s.description  = <<-DESC
Hello_world includes 3rd party ad files. to easy add ads to app
DESC

  s.homepage     = "https://github.com/yanxingcheng/Hello_World"
